    ...
    Ownable2StepUpgradeable
{
    ...
    mockExtendedVRFCoordinatorV2Interface public COORDINATOR;
    ...
    // charges.
    uint32 public s_fulfillmentFlatFeeOKT;
    ...
    uint32 public s_wrapperGasOverhead;
    ...
    uint32 public s_coordinatorGasOverhead;
    ...
    uint8 public s_wrapperPremiumPercentage;
    ...
    function initialize(address _coordinator) public initializer {
        ...
        COORDINATOR = mockExtendedVRFCoordinatorV2Interface(_coordinator);
        // Create this wrapper's subscription and add itself as a consumer.
        uint64 subId = mockExtendedVRFCoordinatorV2Interface(_coordinator)
            .createSubscription();
        SUBSCRIPTION_ID = subId;
        mockExtendedVRFCoordinatorV2Interface(_coordinator).addConsumer(
            subId,
            address(this)
        );
    }
    ...
    function charge(
        ...
        (uint256 requestId, uint256 preseed) = COORDINATOR.requestRandomWords(
            s_keyHash,
            SUBSCRIPTION_ID,
        ...
        lastgaslimit = callbackGasLimit + eip150Overhead + s_wrapperGasOverhead;
    }
     ...
     */
    function getEIP150Overhead(uint32 gas) public pure returns (uint32) {
        return gas / 63 + 1;
    }
...
interface mockExtendedVRFCoordinatorV2Interface is VRFCoordinatorV2Interface {
